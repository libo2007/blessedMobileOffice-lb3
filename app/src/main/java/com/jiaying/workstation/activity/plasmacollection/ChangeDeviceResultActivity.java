...
public class ChangeDeviceResultActivity extends BaseActivity implements OnCountDownTimerFinishCallback {
    ...
    public void initView() {
        setContentView(R.layout.activity_change_device_result);
        new SetTopView(this, R.string.title_activity_change_device_result, true);
    ...
    private void showFailDialog(String title, String msg) {
        ...
        failAllocDialogBuilder.setPositiveButton("重发", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //重新开始倒计时
                countDownTimerUtil = CountDownTimerUtil.getInstance(time_txt, ChangeDeviceResultActivity.this);
                countDownTimerUtil.setOnCountDownTimerFinishCallback(ChangeDeviceResultActivity.this);
